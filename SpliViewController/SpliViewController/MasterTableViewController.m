...
{
    [super viewDidLoad];
    self.websites=@[@"http://www.yahoo.com",@"http://www.apple.com"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    detailViewController.webSite=self.websites[[self.tableView indexPathForSelectedRow].row ];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(showWebsite:)]) {
        [self.delegate showWebsite:self.websites[indexPath.row]];
    }
